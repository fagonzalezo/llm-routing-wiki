...
Usage:
    python3 wiki_graph_extract.py <wiki-dir> [options]
...
Examples:
    python3 wiki_graph_extract.py wiki/
    python3 wiki_graph_extract.py wiki/ --out wiki/graph --formats jsonl,sqlite
"""
