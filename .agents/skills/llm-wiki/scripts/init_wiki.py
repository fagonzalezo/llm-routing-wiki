...
Usage:
    python3 init_wiki.py <project-root> [--wiki-dir wiki] [--raw-dir raw] [--upgrade]

Examples:
    python3 init_wiki.py .
    python3 init_wiki.py . --upgrade
    python3 init_wiki.py ~/research --wiki-dir kb --raw-dir sources
"""
