...
python3 "$SCRIPTS/wiki_graph_extract.py" wiki/

# Navigate.
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ neighbors --node product:konvy
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ edges    --subject person:stephanie-emmanouel
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ path     --from person:praney-behl --to product:konvy
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ facts    --about product:konvy
```
