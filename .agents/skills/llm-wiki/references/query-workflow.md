...
```bash
python3 "$SCRIPTS/wiki_search.py" "your query terms" --top 10
```
...
```bash
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ neighbors --node <node-id>
python3 "$SCRIPTS/wiki_graph_query.py" wiki/ facts    --about <node-id>
```
